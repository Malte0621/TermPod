...
#define POD_AUDIT_ENTRY_POD3_SIZE (POD_AUDIT_ENTRY_USER_SIZE + \
				   POD_AUDIT_ENTRY_TIMESTAMP_SIZE + \
				   POD_AUDIT_ENTRY_ACTION_SIZE + \
				   POD_AUDIT_ENTRY_PATH_SIZE + \
				   POD_AUDIT_ENTRY_DATA_SIZE)
...
/* POD6 header sizes */
#define POD_HEADER_PADDING_SIZE 12
...
#ifdef _WIN32
#define pod_path_append pod_path_append_win32
#else
#define pod_path_append pod_path_append_posix
#endif
